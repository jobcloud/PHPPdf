...
use LaminasPdf\Exception\LogicException;
...
class GraphicsContext extends AbstractGraphicsContext
{
    ...
    {
        return $font->getFontType() === LaminasFont::TYPE_STANDARD;
    }
    ...
    protected function doGoToAction(BaseGraphicsContext $gc, $x1, $y1, $x2, $y2, $top)
    {
        try
        {
            $destination = FitHorizontally::create($gc->getPage(), $top);
